export default function AboutPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white font-serif p-8">
      <div className="max-w-2xl">
        ...
        <div className="space-y-4 text-zinc-300 leading-relaxed">
          ...
          <p>
            ...
            your work as rich text. Made with love by Presian Georgiev.
          </p>
